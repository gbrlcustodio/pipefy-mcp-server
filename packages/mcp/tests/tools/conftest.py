...
def legacy_envelope(monkeypatch):
    ...
    monkeypatch.setattr(get_runtime().mcp, "unified_envelope", False)
    return False
...
def unified_envelope(monkeypatch):
    ...
    monkeypatch.setattr(get_runtime().mcp, "unified_envelope", True)
    return True
...
def envelope_flag(request, monkeypatch):
    ...
    monkeypatch.setattr(get_runtime().mcp, "unified_envelope", request.param)
