...
def map_add_card_comment_error_to_message(exc: BaseException) -> str:
    ...
    if any(marker in haystack for marker in permission_markers):
        # NOTE (debug): raw GraphQL messages often include "Permission denied" / "Not authorized".
        # Keeping this snippet commented for quick troubleshooting if needed:
        # return messages[-1] if messages else "Not authorized"
