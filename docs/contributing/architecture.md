...
- A reviewer wants an ID. A convention ID names how we write code, and [`conventions.md`](conventions.md) is the reference. A `QR` ID names a demand the code must meet, and [Quality requirements](#quality-requirements) is the table.
