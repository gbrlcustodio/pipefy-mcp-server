...
Hard stops and quirks (phase connections UI-only, email template create/edit UI-only, incompatible automation event×action pairs, verify-after-write, AI consent) are documented in the domain skills above; follow those contracts after routing.
